...
const templateCenterStyle7 = document.createElement('template');

templateCenterStyle7.innerHTML = `
...
#grilles {
  ...
  grid-auto-rows: ${(height_box_main_center - 10) / 7}px;
...
#grilles div {
  ...
  font-size : 80px;
  text-align: center;
  line-height: ${(height_box_main_center - 10) / 7}px;
} 
