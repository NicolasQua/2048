...
const templateCenterStyle5 = document.createElement('template');

templateCenterStyle5.innerHTML = `
...
#grilles {
  ...
  grid-auto-rows: ${(height_box_main_center - 10) / 5}px;
